namespace DataTanker.PageManagement
{
    ...
    /// </remarks>
    /// </summary>
    public class CachingPageManager : ICachingPageManager, IDisposable
    {
        ...
        public CachingPageManager(IPageManager underlyingManager, int maxCachedPages, int maxDirtyPages)
        {
